...
const anotherName = new String("Wasam-ur-rehman"); // object  // Do not create Strings objects bcz they produce unexpected results
const name = 'wasam';// Behind the scene yeh bhi object hi invoke kar raha ha  // this is known as string premitive 
...
//console.log(anotherName.__proto__); // access prototypes{} // prototype me buhat sara methods hota han 
...
const newString = anotherName.slice(-11,-1); // keep in mind it will move from right to left 
//                                  L    R

// aother name ====> wasam-ur-rehman
//                      -11        -1
console.log(newString); // is me ham negative values bhi da sakta han  // m-ur-rehma
...
// check whether provided string is presend in the url 
// give strue or false 
...
// console.log(fullName); // Chaudhry Wasam Ur Rehman
...
// String search()
// console.log("Chaudhry Wasam Ur Rehman".search("Wasam")); // 9
